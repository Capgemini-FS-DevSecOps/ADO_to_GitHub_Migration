...
61 gaps recorded across the thirteen components of FR-016 / FR-016a. Sequential ids were
assigned at T035 in file order and are never reused (GAP-051 and GAP-052 were appended on 2026-09-08, GAP-053 on 2026-09-09, GAP-054 on 2026-09-12, GAP-055 through GAP-058 on 2026-09-13 from the behaviour review of the T077 mypy commits, and GAP-059 through GAP-061 on 2026-09-13 from the console safeguard review, each with the next free id); the per-component placeholder each id
...
one of the 61 entries carries at least one path:line citation or a reproduction command
