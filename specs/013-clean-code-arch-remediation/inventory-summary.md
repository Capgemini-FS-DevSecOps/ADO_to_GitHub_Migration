...
- git HEAD: `7a05ca9e989b2428e8a7e9160425db5d7b3a4874`
- functions: 1493 (0)
- clean (no tags, no proposals): 1459 (0)
- rows with open proposals: 2 (0)
...
|---|---:|---:|---:|
| `ado2gh` | 9 | 8 | 0 |
| `ado2gh/agents` | 378 | 368 | 0 |
| `ado2gh/api` | 321 | 318 | 0 |
| `ado2gh/audit` | 5 | 5 | 0 |
| `ado2gh/auth` | 26 | 26 | 0 |
| `ado2gh/cli` | 9 | 9 | 0 |
...
| `services/accelerator_api` | 152 | 149 | 2 |
...
- exports: 204
- clean (no tags, no proposals): 196
