/**
 * The LLM models page holds provider API keys (register id GAP-025).
 *
 * Without `can_manage_models` it must render the denial only — no key input, no catalog
 * control. The request shape for the catalog lookup — the key goes in a POST body,
 * never a query string (register id GAP-012) — is asserted against `fetchCatalog`, which this page calls, in
