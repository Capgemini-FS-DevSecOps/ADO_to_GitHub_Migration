...
def configure_tracing_from_env() -> bool:
    """Log tracing status at agent startup. LangChain reads environment variables automatically."""
...
def graph_run_config(
    ...
    *,
    ...
    """Build LangGraph invoke configuration with thread_id for checkpoint + trace correlation."""
