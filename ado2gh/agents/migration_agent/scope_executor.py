...
def build_agent_work_items_for_session(
    ...
    *,
    ...
    from ado2gh.agents.migration_agent.pipeline_plan import pipeline_counts_from_discovery
...
def resolve_repo_context(
    ...
    from ado2gh.agents.migration_agent.pipeline_plan import resolve_github_org
